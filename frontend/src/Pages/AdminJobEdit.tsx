...
import { getJob, updateJob } from "../Services/jobsListApi";
...
export default function AdminJobEdit() {
  ...
  const { step, steps: s, data, patch, next, prev, isLast } = useFormWizard<JobDraft>(steps, {});
  ...
  useEffect(() => {
    ...
    getJob(jobId).then((job: any) => {
      ...
      const initialData: JobDraft = {
        ...
        missions_text: (job.missions || []).join('\n'),
        ...
        salary_is_confidential: job.salary_is_confidential || false,
      ...
      // Set missions array for rich text editing
  ...
  return (
    <>
    <SRMultiStep title="Edit Job" subtitle="Modify the job details using the steps below" steps={s} active={step}>
      {step===0 && (
        <>
          ...
          <SRSection title="Role Content">
            <div className="srForm__field">
              ...
              <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                ...
                >
                  {data.company_overview ? <><Pencil size={16} /> Edit Company Overview</> : 'ðŸ“ Add Company Overview'}
                </button>
            ...
            <div className="srForm__field">
              ...
              <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                <button
                  ...
                  style={{flex: 1, justifyContent: 'flex-start'}}
                >
                  {data.offer_description ? <><Pencil size={16} /> Edit Offer Description</> : 'ðŸ“ Add Offer Description'}
                </button>
            ...
            <div className="srForm__field">
              ...
              <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                <button
                  ...
                  style={{flex: 1, justifyContent: 'flex-start'}}
                >
                  {missionsHTML ? <><Pencil size={16} /> Edit Missions</> : 'ðŸ“ Add Missions'}
                </button>
                {missionsHTML && (
                  <button
                    type="button"
            ...
            <div className="srForm__field">
              ...
              <div style={{display: 'flex', gap: '8px', alignItems: 'center'}}>
                <button
                  ...
                  style={{flex: 1, justifyContent: 'flex-start'}}
                >
                  {data.profile_requirements ? <><Pencil size={16} /> Edit Profile Requirements</> : 'ðŸ“ Add Profile Requirements'}
                </button>
    ...
    <SuccessModal
      open={showSuccess}
      title={data.title || ""}
      onClose={() => { setShowSuccess(false); nav('/admin/jobs'); }}
      createdId={jobId.toString()}
